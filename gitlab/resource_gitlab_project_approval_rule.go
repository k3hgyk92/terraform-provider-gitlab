...
func resourceGitlabProjectApprovalRule() *schema.Resource {
	return &schema.Resource{
		Description: "This resource allows you to create and manage multiple approval rules for your GitLab\n" +
		...
		Schema: map[string]*schema.Schema{
			...
			"protected_branch_ids": {
				Description: "A list of protected branch IDs for which the rule applies.",
				Type:        schema.TypeSet,
				Optional:    true,
				Elem:        &schema.Schema{Type: schema.TypeInt},
				Set:         schema.HashInt,
